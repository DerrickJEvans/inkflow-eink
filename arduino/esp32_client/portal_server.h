/*
  portal_server.h - Web portal AP configuration server for ESP32 Client
*/
...
<body>
  <div class="card">
    ...
    <p>Your InkFlow ESP32 device is now rebooting to connect to <strong>)rawliteral" + ssid + R"rawliteral(</strong>.</p>
