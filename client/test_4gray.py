...
def main():
    ...
    # Colors: White (255), Light Gray (170), Dark Gray (85), Black (0)
    bands = [
        {"color": 255, "label": "SHADE 1: WHITE (Value 255)", "text_color": 0},
        {"color": 170, "label": "SHADE 2: LIGHT GRAY (Value 170)", "text_color": 0},
        {"color": 85, "label": "SHADE 3: DARK GRAY (Value 85)", "text_color": 255},
        {"color": 0, "label": "SHADE 4: BLACK (Value 0)", "text_color": 255}
    ]
    ...
    for idx, band in enumerate(bands):
        ...
        text_y = y_start + (band_h // 2) - 10
        draw.text((30, text_y), band["label"], fill=band["text_color"], font=font)
        
        # Draw a small inner contrasting rectangle to verify edge transitions
        rect_x_start = width - 150
        rect_x_end = width - 30
        rect_y_start = y_start + 15
        rect_y_end = y_end - 15
        draw.rectangle([rect_x_start, rect_y_start, rect_x_end, rect_y_end], fill=band["text_color"], outline=128, width=2)
